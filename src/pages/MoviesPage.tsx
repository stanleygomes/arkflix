...
import { Clock, Star, ArrowDownAZ, Calendar, Film } from 'lucide-react'
      ...
      <div className="min-h-screen pt-[max(env(safe-area-inset-top,0px)+4.5rem,5.25rem)] sm:pt-28 pb-20 px-4 sm:px-6 md:px-14 max-w-7xl mx-auto space-y-4 sm:space-y-6 animate-fadeIn">
        ...
        {isLoading ? (
          ...
          <EmptyState
            ...
            description="Não encontramos filmes disponíveis na sua biblioteca Jellyfin. Puxe para atualizar ou sincronize seu servidor."
